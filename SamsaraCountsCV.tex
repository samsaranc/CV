...
Identify high-quality datasets for training NLP algorithms and cleaned datasets using Python and R\\
\end{tabular}
...
\begin{tabular}{@{}lP{6.3cm}lP{8.3cm}r@{}}
 %\toprule
2019  &   kc claffy: 10 Things You Need to Know About the Internet &  The Internet Distinguished Speaker Series, GW Dept. of Computer Science \\
2019  &   Vint Cerf: The Unfinished Internet & The Internet Distinguished Speaker Series, GW Dept. of Computer Science  \\
