...
Developed a mobile application and website using Play framework for adult learners to increase English literacy\\
...
{\def\next{\\\\[-0.2cm]}\fontsize{10}{12pt}\selectfont
\begin{tabular}{@{}lP{8.3cm}lP{10.3cm}r@{}}
...
2017-2018  &   Git, Command Line, and Linux Workshop & GW Association for Computing Machinery 
