...
2019-2020 & \text{ } & Saarland University & \textit{Data Science and Artificial Intelligence} & visiting M.S. student
\end{tabular}
...
\subsection{Max Planck Institute for Software Systems | \emph{Research Intern} | \text{October 2019--July 2020 (expected)} }
~\begin{tabular}{@{~$\bullet$~~}l}
Investigate mechanisms of incorporating fairness and diversity into Machine Learning algorithms \\
\textit{Advised by Krishna Gummadi}\\
\end{tabular}


\subsection{George Washington University | \emph{Researcher} | \text{Fall 2017--May 2019} }
~\begin{tabular}{@{~$\bullet$~~}l}
Used deep learning to recognize images of Eating Disorders and build tools to improve patient health outcomes \\
...
Identified high-quality datasets for training NLP algorithms and cleaned datasets using Python\\
